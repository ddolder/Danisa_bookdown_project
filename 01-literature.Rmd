...
```
```{r include=FALSE}
#contar la cantidad de estaciones
...
```
The available data are from April to November. These data were divided by station and filtered by year and month. The data from the same month was averaged. However, there are months in which there are no Chl-a data.The table 3.2 shows the processed data for the station 4917500. 
...
After analyzed the data of each station, there were find many missing values for the chl-a parameter. Due to the station 4917450 is the only one that does not have missing values, all the analysis of this project is going to be perform with this specific data set. 